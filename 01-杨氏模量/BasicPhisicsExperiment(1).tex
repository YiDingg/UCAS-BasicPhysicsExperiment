% Template of basic phisics experiment 基于 report template，在此基础上做修改
...
\usepackage{enumitem} % 导入 enumitem 宏包，用于设置列表环境
...
\usepackage{titlesec}   
    % section标题自定义设置 
    \titleformat{\section}[hang]{\normalfont\huge\bfseries\centering\centering}{第\,\thesection\,部分}{20pt}{}
    % subsection标题自定义设置 
    \titleformat{\subsection}[hang]{\normalfont\Large\bfseries}{\,\thesubsection\,}{8pt}{}
    % subsubsection标题自定义设置
    \titleformat{\subsubsection}[hang]{\normalfont\large\bfseries}{\,\thesubsubsection\,}{6pt}{}

    \usepackage{etoolbox} % 加载etoolbox宏包  
